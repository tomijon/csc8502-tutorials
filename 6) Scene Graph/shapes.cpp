...
void Frustum::FromMatrix(const Matrix4& mat) {
	...
	Vector3 yaxis = Vector3(mat.values[1], mat.values[5], mat.values[8]);
	Vector3 zaxis = Vector3(mat.values[2], mat.values[6], mat.values[9]);
	Vector3 waxis = Vector3(mat.values[3], mat.values[7], mat.values[10]);
